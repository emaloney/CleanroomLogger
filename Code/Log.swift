...
public struct Log
{
    ...
    - parameter     minimumSeverity: The minimum `LogSeverity` for which log messages
    ...
    */
    ...
    - parameter     configuration: The list of `LogConfiguration`s to use for controlling
                the behavior of logging.
    ...
    */
    ...
    - parameter     receptacle: The list of `LogConfiguration`s to use for controlling
                the behavior of logging.
    ...
    */
    ...
    - parameter     warningChannel: The `LogChannel` to use for logging messages with
    ...
    - parameter     verboseChannel: The `LogChannel` to use for logging messages with
